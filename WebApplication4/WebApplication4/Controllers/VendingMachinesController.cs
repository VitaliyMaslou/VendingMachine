...
namespace WebApplication4.Controllers
{
    ...
    public class VendingMachinesController : ControllerBase
    {
        ...
        public VendingMachinesController(VendingmachinedatabaseContext context)
        {
            _context = context;
        }

        // GET: api/VendingMachines1
        [HttpGet]
